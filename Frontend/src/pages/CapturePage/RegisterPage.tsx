...
export default function RegisterPage() {
	...
	return (
	  ...
	  >
		...
		<div className='flex flex-col justify-center items-center w-full lg:w-1/3 h-full py-2 rounded-2xl bg-white shadow-xl shadow-zinc-950'>
		  ...
		  >
			...
			<div
			  ...
			  className='flex justify-center items-center w-full h-20 rounded-md outline-0 relative'
			>
			...
			<div
			  className="flex flex-col items-center justify-center w-full h-1/3 mt-4"
			>
